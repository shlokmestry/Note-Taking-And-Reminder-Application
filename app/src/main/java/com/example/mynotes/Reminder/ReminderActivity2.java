...
public class ReminderActivity2 extends AppCompatActivity {



    TextView mDatebtn, mTimebtn, mSubmitbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatebtn = (TextView) findViewById(R.id.btnDate);                                             //assigned all the material reference to get and set data
        mTimebtn = (TextView) findViewById(R.id.btnTime);
        mSubmitbtn = (TextView) findViewById(R.id.btnSubmit);
    ...
    private void setAlarm(String text, String date, String time) {
        ...
        Intent intentBack = new Intent(getApplicationContext(), ReminderActivity.class);                //this intent will be called once the setting alaram is completes
